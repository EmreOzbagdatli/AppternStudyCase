...
class LikedPageViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.favoritesList = FavoritesManager.shared.getFavorites()
...
extension LikedPageViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.likedImageView.kf.setImage(with: URL(string: "\(track.cover_xl ?? "")"), placeholder: nil, options: [.transition(.fade(0.7))])
